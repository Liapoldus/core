...
type Config struct {
	...
	// MaxPacketSize is the maximum UDP payload size of packets sent on any path.
	// Values outside the QUIC packet bounds are clipped during config normalization.
