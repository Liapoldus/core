  ...
  it("lists and reads SQLite groups with revision pointers and safe not-found responses", async () => {
    ...
    try {
      ...
      expect(JSON.parse(result.stdout)).toEqual({
        ...
        activationCountAfterPublish: 1,
        currentAfterPublish: expect.any(String),
        currentAfterConflict: expect.any(String),
        activationFailureStatus: 202,
        activationFailureOperationState: "failed",
        currentBeforeActivationFailure: expect.any(String),
        currentAfterActivationFailure: expect.any(String),
        previousBeforeActivationFailure: expect.any(String),
        previousAfterActivationFailure: expect.any(String),
        runtimeAfterActivationFailure: "old-snapshot",
        ...
        currentBeforeStale: "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa",
